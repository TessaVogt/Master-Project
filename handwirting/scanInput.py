...
def extract_rectangle_images(image_path, rectangles, output_dir, padding=5):
    order = [char for char in "ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜabcdefghijklmnopqrstuvwxyzäöü1234567890"]
    order = order + ["period", "comma", "simicolon", "question_mark", "exclamation_mark", "at_sign", "and", "percent", "euro", "quotation_marks_below", "quotation_marks_above", "close_parenthesis", "open_parenthesis", "hashtag", "hyphen"] # .,;?!@&%€\'\"()#-
    print(order)
...
if __name__ == "__main__":
    ...
    input_file_name = 'Buchstaben1.pdf'
